...
class _CameraHomePageState extends State<CameraHomePage>
  ...
  Future<void> _initializeCamera() async {
    ...
    // Jangan menjalankan initialize() berkali-kali secara bersamaan.
    _cameraBusy = true;
    ...
    try {
      ...
      // Pengaturan tambahan dilakukan setelah preview siap supaya startup tidak
      // tertahan oleh operasi kamera sekunder. Jika salah satu tidak didukung
      // perangkat, preview tetap dapat digunakan.
      try {
      ...
      if (mounted && token == _cameraInitToken) {
        ...
        _message('Kamera belum siap. Coba lagi.');
      }
    } finally {
      _cameraBusy = false;
    }
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    // Jangan dispose controller hanya karena inactive/paused. Pada beberapa
    // perangkat, hal ini memaksa Camera2 melakukan cold-start kembali dan
    // menghasilkan loading beberapa detik saat layar dinyalakan.
