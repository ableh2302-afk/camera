...
class _CameraHomePageState extends State<CameraHomePage>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.inactive ||
      ...
      if (_camera == null && !_cameraBusy && cameras.isNotEmpty) {
        if (mounted) {
          setState(() {
            _initializing = true;
        ...
        // Wait for Android's activity/texture to be fully resumed before
        // opening the camera. A short delay avoids the common "camera not
        // ready" state immediately after turning the screen back on.
