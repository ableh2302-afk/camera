...
class _CameraHomePageState extends State<CameraHomePage>
  ...
  Widget _cameraPreview() {
    ...
    // FittedBox + BoxFit.cover menjaga rasio asli kamera tanpa membuat
    // gambar cembung/tertarik. Sisi yang berlebih hanya dipotong.
    return ClipRect(
...
class _PhotoEditorPageState extends State<PhotoEditorPage> {
  ...
  void _drawCircleOutline(
    ...
    final outer = math.max(1, radius);
    final inner = math.max(0, outer - math.max(1, thickness));
      ...
      case EditTool.annotate:
        return Column(children: [
          SizedBox(
            ...
            child: ListView(
              scrollDirection: Axis.horizontal,
              children: AnnotationMode.values.map<Widget>((m) {
                return Padding(
