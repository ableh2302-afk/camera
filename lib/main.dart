...
class _CameraHomePageState extends State<CameraHomePage>
  ...
  Future<void> _initializeCamera() async {
    ...
    try {
      ...
      // Publish the new controller first and give Flutter a frame to attach
      // the new camera texture before disposing the previous controller.
      // Disposing the old texture in the same frame can leave the new
      // CameraPreview blank on some Android devices, especially when
  ...
  Future<void> _switchCamera() async {
    // Keep the current preview alive while the other camera initializes.
    // This avoids the visible black/loading screen during camera switching.
