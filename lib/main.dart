...
class _CameraHomePageState extends State<CameraHomePage>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.inactive ||
      ...
      // Android can revoke the camera resource while the app is not visible.
      // Dispose it safely, but do not show a permanent "camera not ready" state.
      ++_cameraInitToken;
      ...
      // Re-open asynchronously after Android has returned the camera resource.
      // Keep the UI in recovery mode instead of showing a false error message.
